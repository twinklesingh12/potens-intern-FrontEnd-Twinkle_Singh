...
const translations = {
  en: {
    ...
    holdMessage: 'Request is on hold',
    pauseLabel: 'Pause',
    resumeActionsLabel: 'Resume actions',
    approvedCountLabel: 'approved',
    systemHealthDetailGood: 'Stable risk profile',
    systemHealthDetailWatch: 'Elevated risk, monitor closely',
    approve: 'Approve',
    hold: 'Hold',
    languageOptions: {
      en: 'English',
  ...
  hi: {
    ...
    mediumLabel: 'मध्यम',
    criticalLabel: 'गंभीर',
    holdMessage: 'अनुरोध होल्ड पर है',
    pauseLabel: 'पॉज़',
    resumeActionsLabel: 'एक्शन फिर से चालू करें',
    approvedCountLabel: 'स्वीकृत',
    systemHealthDetailGood: 'जोखिम प्रोफाइल स्थिर',
    systemHealthDetailWatch: 'जोखिम बढ़ा हुआ, कड़ी निगरानी रखें',
